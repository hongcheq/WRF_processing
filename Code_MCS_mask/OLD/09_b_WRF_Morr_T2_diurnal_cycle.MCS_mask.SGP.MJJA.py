...
#ds_WRF = xr.open_dataset('/home/qin5/Data/WRF_postprocessing/WRF_Morri/WRF.postprocessing.extract.hourly.0.04.T2.time_revise.nc')
...
#####
var_regrid_yes_MCS = ds_WRF['T2_regrid'].where(WRF_MCS_mask > 0)
var_regrid_no_MCS = ds_WRF['T2_regrid'].where(np.isnan(WRF_MCS_mask))
...
fig.savefig("../Figure_MCS_mask/07_b_Precip.OBS_vs_WRF_Morri"+label_string+".MCS_masks.png",dpi=600,bbox_inches="tight")
plt.show()
