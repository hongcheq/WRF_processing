...
ax5.plot(x_axis[0:120], (EF_WRF_Thom_SGP.values - EF_ARM_SGP[0:120].values) , 'r-', label='WRF'+label_string2)
...
ax6.plot(x_axis[0:120], (T2_WRF_Thom_SGP.values - temp_ARM_SGP[0:120].values) , 'r-', label='WRF'+label_string2)
ax6.grid()
