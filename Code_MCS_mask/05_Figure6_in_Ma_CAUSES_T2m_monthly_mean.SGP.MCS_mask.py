...
ds_WRF = xr.open_dataset('/home/qin5/Data/WRF_postprocessing/WRF_Morri/WRF.postprocessing.extract.hourly.0.04.T2.ncrcat.nc')
...
T2_regrid_yes_MCS = ds_WRF['T2_regrid'].where(WRF_MCS_mask > 0)
T2_regrid_no_MCS = ds_WRF['T2_regrid'].where(np.isnan(WRF_MCS_mask))

#print(T2_regrid_yes_MCS)
#print(T2_regrid_no_MCS)

### with MCS ###
T2_WRF_month_yes_MCS = T2_regrid_yes_MCS.resample(time='MS').mean(dim='time')
T2_WRF_May_yes_MCS = T2_WRF_month_yes_MCS[0,:,:]
T2_WRF_Jun_yes_MCS = T2_WRF_month_yes_MCS[1,:,:]
T2_WRF_Jul_yes_MCS = T2_WRF_month_yes_MCS[2,:,:]
T2_WRF_Aug_yes_MCS = T2_WRF_month_yes_MCS[3,:,:]
T2_WRF_JJA_yes_MCS = (T2_WRF_Jun_yes_MCS + T2_WRF_Jul_yes_MCS + T2_WRF_Aug_yes_MCS)/3.0
T2_WRF_MJJA_yes_MCS = (T2_WRF_May_yes_MCS + T2_WRF_Jun_yes_MCS + T2_WRF_Jul_yes_MCS + T2_WRF_Aug_yes_MCS)/4.0

WRF_May_yes_MCS = T2_WRF_May_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
WRF_Jun_yes_MCS = T2_WRF_Jun_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
WRF_Jul_yes_MCS = T2_WRF_Jul_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
WRF_Aug_yes_MCS = T2_WRF_Aug_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
WRF_JJA_yes_MCS = T2_WRF_JJA_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
WRF_MJJA_yes_MCS = T2_WRF_MJJA_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')

### without MCS ###
T2_WRF_month_no_MCS = T2_regrid_no_MCS.resample(time='MS').mean(dim='time')
T2_WRF_May_no_MCS = T2_WRF_month_no_MCS[0,:,:]
T2_WRF_Jun_no_MCS = T2_WRF_month_no_MCS[1,:,:]
T2_WRF_Jul_no_MCS = T2_WRF_month_no_MCS[2,:,:]
T2_WRF_Aug_no_MCS = T2_WRF_month_no_MCS[3,:,:]
T2_WRF_JJA_no_MCS = (T2_WRF_Jun_no_MCS + T2_WRF_Jul_no_MCS + T2_WRF_Aug_no_MCS)/3.0
T2_WRF_MJJA_no_MCS = (T2_WRF_May_no_MCS + T2_WRF_Jun_no_MCS + T2_WRF_Jul_no_MCS + T2_WRF_Aug_no_MCS)/4.0

WRF_May_no_MCS = T2_WRF_May_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
WRF_Jun_no_MCS = T2_WRF_Jun_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
WRF_Jul_no_MCS = T2_WRF_Jul_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
WRF_Aug_no_MCS = T2_WRF_Aug_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
WRF_JJA_no_MCS = T2_WRF_JJA_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
WRF_MJJA_no_MCS = T2_WRF_MJJA_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
...
ax1.scatter(x_axis, [WRF_May_yes_MCS, WRF_Jun_yes_MCS, WRF_Jul_yes_MCS, WRF_Aug_yes_MCS, WRF_JJA_yes_MCS, WRF_MJJA_yes_MCS], c='b',marker='s', label='WRF_Morr_yes_MCS')
ax1.scatter(x_axis, [WRF_May_no_MCS, WRF_Jun_no_MCS, WRF_Jul_no_MCS, WRF_Aug_no_MCS, WRF_JJA_no_MCS, WRF_MJJA_no_MCS], c='y',marker='o', label='WRF_Morr_no_MCS')
...
fig.savefig("../Figure_MCS_mask/Figure6.T2m.WRF_Morri_Thom_vs_ARM_SGP.MCS_mask.png",dpi=600)
plt.show()
