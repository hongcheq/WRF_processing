...
ds_ARMBE2D_var = xr.open_dataset('/home/qin5/Data/ARMBE2DGRID/OBS_MCS_mask_consistency/sgparmbe2dgridX1.c1.201105_08.time_revise.temp.nc')
...
fig.savefig("../Figure_MCS_mask/09_b_"+str_var_plt+".OBS_vs_WRF_Morri"+label_string+".MCS_masks.png",dpi=600,bbox_inches="tight")
plt.show()
