...
ds_WRF = xr.open_dataset('/home/qin5/Data/WRF_postprocessing/WRF_Morri/WRF.postprocessing.extract.hourly.0.04.HFX.time_revise.nc')
...
ds_ARMBE2D_var = xr.open_dataset('/home/qin5/Data/ARMBE2DGRID/OBS_MCS_mask_consistency/sgparmbe2dgridX1.c1.201105_08.time_revise.sensible_heat_flux.nc')
...
var_regrid_yes_MCS = ds_WRF['HFX_regrid'].where(WRF_MCS_mask > 0)
var_regrid_no_MCS = ds_WRF['HFX_regrid'].where(np.isnan(WRF_MCS_mask))
...
ARMBE_var = -ds_ARMBE2D_var['sensible_heat_flux']
str_var_plt = "HFX"
...
fig.savefig("../Figure_MCS_mask/09_c_"+str_var_plt+".OBS_vs_WRF_Morri"+label_string+".MCS_masks.png",dpi=600,bbox_inches="tight")
plt.show()
