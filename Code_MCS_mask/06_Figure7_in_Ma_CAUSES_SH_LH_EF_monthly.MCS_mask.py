...
ds_WRF_HFX = xr.open_dataset('/home/qin5/Data/WRF_postprocessing/WRF_Morri/WRF.postprocessing.extract.hourly.0.04.HFX.ncrcat.nc')
...
HFX_regrid_yes_MCS = ds_WRF_HFX['HFX_regrid'].where(WRF_MCS_mask > 0)
HFX_regrid_no_MCS = ds_WRF_HFX['HFX_regrid'].where(np.isnan(WRF_MCS_mask))

######
LH_WRF_month_yes_MCS = LH_regrid_yes_MCS.resample(time='MS').mean(dim='time')
LH_WRF_May_yes_MCS = LH_WRF_month_yes_MCS[0,:,:]
LH_WRF_Jun_yes_MCS = LH_WRF_month_yes_MCS[1,:,:]
LH_WRF_Jul_yes_MCS = LH_WRF_month_yes_MCS[2,:,:]
LH_WRF_Aug_yes_MCS = LH_WRF_month_yes_MCS[3,:,:]
LH_WRF_JJA_yes_MCS = (LH_WRF_Jun_yes_MCS + LH_WRF_Jul_yes_MCS + LH_WRF_Aug_yes_MCS)/3.0
LH_WRF_MJJA_yes_MCS = (LH_WRF_May_yes_MCS + LH_WRF_Jun_yes_MCS + LH_WRF_Jul_yes_MCS + LH_WRF_Aug_yes_MCS)/4.0

LH_WRF_month_no_MCS = LH_regrid_no_MCS.resample(time='MS').mean(dim='time')
LH_WRF_May_no_MCS = LH_WRF_month_no_MCS[0,:,:]
LH_WRF_Jun_no_MCS = LH_WRF_month_no_MCS[1,:,:]
LH_WRF_Jul_no_MCS = LH_WRF_month_no_MCS[2,:,:]
LH_WRF_Aug_no_MCS = LH_WRF_month_no_MCS[3,:,:]
LH_WRF_JJA_no_MCS = (LH_WRF_Jun_no_MCS + LH_WRF_Jul_no_MCS + LH_WRF_Aug_no_MCS)/3.0
LH_WRF_MJJA_no_MCS = (LH_WRF_May_no_MCS + LH_WRF_Jun_no_MCS + LH_WRF_Jul_no_MCS + LH_WRF_Aug_no_MCS)/4.0


HFX_WRF_month_yes_MCS = HFX_regrid_yes_MCS.resample(time='MS').mean(dim='time')
HFX_WRF_May_yes_MCS = HFX_WRF_month_yes_MCS[0,:,:]
HFX_WRF_Jun_yes_MCS = HFX_WRF_month_yes_MCS[1,:,:]
HFX_WRF_Jul_yes_MCS = HFX_WRF_month_yes_MCS[2,:,:]
HFX_WRF_Aug_yes_MCS = HFX_WRF_month_yes_MCS[3,:,:]
HFX_WRF_JJA_yes_MCS = (HFX_WRF_Jun_yes_MCS + HFX_WRF_Jul_yes_MCS + HFX_WRF_Aug_yes_MCS)/3.0
HFX_WRF_MJJA_yes_MCS = (HFX_WRF_May_yes_MCS + HFX_WRF_Jun_yes_MCS + HFX_WRF_Jul_yes_MCS + HFX_WRF_Aug_yes_MCS)/4.0

HFX_WRF_month_no_MCS = HFX_regrid_no_MCS.resample(time='MS').mean(dim='time')
HFX_WRF_May_no_MCS = HFX_WRF_month_no_MCS[0,:,:]
HFX_WRF_Jun_no_MCS = HFX_WRF_month_no_MCS[1,:,:]
HFX_WRF_Jul_no_MCS = HFX_WRF_month_no_MCS[2,:,:]
HFX_WRF_Aug_no_MCS = HFX_WRF_month_no_MCS[3,:,:]
HFX_WRF_JJA_no_MCS = (HFX_WRF_Jun_no_MCS + HFX_WRF_Jul_no_MCS + HFX_WRF_Aug_no_MCS)/3.0
HFX_WRF_MJJA_no_MCS = (HFX_WRF_May_no_MCS + HFX_WRF_Jun_no_MCS + HFX_WRF_Jul_no_MCS + HFX_WRF_Aug_no_MCS)/4.0

####
L_WRF_May_yes_MCS = LH_WRF_May_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
L_WRF_Jun_yes_MCS = LH_WRF_Jun_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
L_WRF_Jul_yes_MCS = LH_WRF_Jul_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
L_WRF_Aug_yes_MCS = LH_WRF_Aug_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
L_WRF_JJA_yes_MCS = LH_WRF_JJA_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
L_WRF_MJJA_yes_MCS = LH_WRF_MJJA_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')

L_WRF_May_no_MCS = LH_WRF_May_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
L_WRF_Jun_no_MCS = LH_WRF_Jun_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
L_WRF_Jul_no_MCS = LH_WRF_Jul_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
L_WRF_Aug_no_MCS = LH_WRF_Aug_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
L_WRF_JJA_no_MCS = LH_WRF_JJA_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
L_WRF_MJJA_no_MCS = LH_WRF_MJJA_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')

###

SH_WRF_May_yes_MCS = HFX_WRF_May_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
SH_WRF_Jun_yes_MCS = HFX_WRF_Jun_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
SH_WRF_Jul_yes_MCS = HFX_WRF_Jul_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
SH_WRF_Aug_yes_MCS = HFX_WRF_Aug_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
SH_WRF_JJA_yes_MCS = HFX_WRF_JJA_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
SH_WRF_MJJA_yes_MCS = HFX_WRF_MJJA_yes_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')

SH_WRF_May_no_MCS = HFX_WRF_May_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
SH_WRF_Jun_no_MCS = HFX_WRF_Jun_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
SH_WRF_Jul_no_MCS = HFX_WRF_Jul_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
SH_WRF_Aug_no_MCS = HFX_WRF_Aug_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
SH_WRF_JJA_no_MCS = HFX_WRF_JJA_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
SH_WRF_MJJA_no_MCS = HFX_WRF_MJJA_no_MCS.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')


### Add evaporative fraction here 
EF_WRF_May_yes_MCS = L_WRF_May_yes_MCS / (L_WRF_May_yes_MCS + SH_WRF_May_yes_MCS)
EF_WRF_Jun_yes_MCS = L_WRF_Jun_yes_MCS / (L_WRF_Jun_yes_MCS + SH_WRF_Jun_yes_MCS)
EF_WRF_Jul_yes_MCS = L_WRF_Jul_yes_MCS / (L_WRF_Jul_yes_MCS + SH_WRF_Jul_yes_MCS)
EF_WRF_Aug_yes_MCS = L_WRF_Aug_yes_MCS / (L_WRF_Aug_yes_MCS + SH_WRF_Aug_yes_MCS)
EF_WRF_JJA_yes_MCS = L_WRF_JJA_yes_MCS / (L_WRF_JJA_yes_MCS + SH_WRF_JJA_yes_MCS)
EF_WRF_MJJA_yes_MCS = L_WRF_MJJA_yes_MCS / (L_WRF_MJJA_yes_MCS + SH_WRF_MJJA_yes_MCS)

EF_WRF_May_no_MCS = L_WRF_May_no_MCS / (L_WRF_May_no_MCS + SH_WRF_May_no_MCS)
EF_WRF_Jun_no_MCS = L_WRF_Jun_no_MCS / (L_WRF_Jun_no_MCS + SH_WRF_Jun_no_MCS)
EF_WRF_Jul_no_MCS = L_WRF_Jul_no_MCS / (L_WRF_Jul_no_MCS + SH_WRF_Jul_no_MCS)
EF_WRF_Aug_no_MCS = L_WRF_Aug_no_MCS / (L_WRF_Aug_no_MCS + SH_WRF_Aug_no_MCS)
EF_WRF_JJA_no_MCS = L_WRF_JJA_no_MCS / (L_WRF_JJA_no_MCS + SH_WRF_JJA_no_MCS)
EF_WRF_MJJA_no_MCS = L_WRF_MJJA_no_MCS / (L_WRF_MJJA_no_MCS + SH_WRF_MJJA_no_MCS)
...
ax1.scatter(x_axis, [L_WRF_May_yes_MCS, L_WRF_Jun_yes_MCS, L_WRF_Jul_yes_MCS, L_WRF_Aug_yes_MCS, L_WRF_JJA_yes_MCS, L_WRF_MJJA_yes_MCS], c='b',marker='s', label='WRF_Morr_yes_MCS')
ax1.scatter(x_axis, [L_WRF_May_no_MCS, L_WRF_Jun_no_MCS, L_WRF_Jul_no_MCS, L_WRF_Aug_no_MCS, L_WRF_JJA_no_MCS, L_WRF_MJJA_no_MCS], c='y',marker='o', label='WRF_Morr_no_MCS')
...
ax1.grid()
ax1.legend(bbox_to_anchor=(1.05, 1),loc='upper left', borderaxespad=0.,prop={'size': fontsize})

ax2 = fig.add_subplot(3,1,2)
ax2.text(s='Sensible Heat Flux, W/m2', x=0, y=1.02, ha='left', va='bottom', \
        fontsize=fontsize, transform=ax2.transAxes)
ax2.scatter(x_axis, [SH_WRF_May_yes_MCS, SH_WRF_Jun_yes_MCS, SH_WRF_Jul_yes_MCS, SH_WRF_Aug_yes_MCS, SH_WRF_JJA_yes_MCS, SH_WRF_MJJA_yes_MCS], c='b',marker='s', label='WRF_Morr_yes_MCS')
ax2.scatter(x_axis, [SH_WRF_May_no_MCS, SH_WRF_Jun_no_MCS, SH_WRF_Jul_no_MCS, SH_WRF_Aug_no_MCS, SH_WRF_JJA_no_MCS, SH_WRF_MJJA_no_MCS], c='y',marker='o', label='WRF_Morr_no_MCS')
...
ax2.grid()
ax2.legend(bbox_to_anchor=(1.05, 1),loc='upper left', borderaxespad=0.,prop={'size': fontsize})

ax3 = fig.add_subplot(3,1,3)
ax3.text(s='Evaporative Fraction, unitless', x=0, y=1.02, ha='left', va='bottom', \
        fontsize=fontsize, transform=ax3.transAxes)
ax3.scatter(x_axis, [EF_WRF_May_yes_MCS, EF_WRF_Jun_yes_MCS, EF_WRF_Jul_yes_MCS, EF_WRF_Aug_yes_MCS, EF_WRF_JJA_yes_MCS, EF_WRF_MJJA_yes_MCS], c='b',marker='s', label='WRF_Morr_yes_MCS')
ax3.scatter(x_axis, [EF_WRF_May_no_MCS, EF_WRF_Jun_no_MCS, EF_WRF_Jul_no_MCS, EF_WRF_Aug_no_MCS, EF_WRF_JJA_no_MCS, EF_WRF_MJJA_no_MCS], c='y',marker='o', label='WRF_Morr_no_MCS')
...
ax3.grid()
ax3.legend(bbox_to_anchor=(1.05, 1),loc='upper left', borderaxespad=0.,prop={'size': fontsize})

fig.savefig("../Figure_MCS_mask/Figure7.SH.LH.EF.WRF_Morri_Thom_vs_ARM_SGP_FLUXNET_GLEAM.MCS_mask.png",dpi=600,bbox_inches="tight")
plt.show()
