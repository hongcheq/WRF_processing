...
ax1.set(xlabel='month category', ylabel='Latent heat flux, W/m2', title='WRF vs obs @Nebraska')
ax1.grid()
...
fig.savefig("../Figure/Figure7.SH.LH.EF.WRF_Morri_Thom_vs_obs_Nebraska_FLUXNET_GLEAM.png",dpi=600)
plt.show()
