...
ax1.set(xlabel='LST(hr), UTC-6', ylabel='WRF precip bias, mm/day', title='Precip, WRF'+label_string+' vs ARM SGP')
ax1.grid()
...
fig.savefig("../Figure/Precip.Diurnal.MJJA.WRF_vs_ARM_SGP."+label_string+".png",dpi=600)
plt.show()
