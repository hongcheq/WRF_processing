...
HFX_JJA_Thom = HFX_regrid_Thom[738:,:,:]
LH_JJA_Thom = LH_regrid_Thom[738:,:,:]
...
HFX_WRF_JJA_Thom = HFX_JJA_Thom.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')
LH_WRF_JJA_Thom = LH_JJA_Thom.sel(lat=slice(lat_1, lat_2), lon=slice(lon_1, lon_2)).mean(dim='lat').mean(dim='lon')

WRF_JJA_SH = HFX_WRF_JJA.groupby('time.hour').mean()
WRF_JJA_LH = LH_WRF_JJA.groupby('time.hour').mean()

WRF_JJA_SH_Thom = HFX_WRF_JJA_Thom.groupby('time.hour').mean()
WRF_JJA_LH_Thom = LH_WRF_JJA_Thom.groupby('time.hour').mean()
...
bias_JJA_SH_Thom = WRF_JJA_SH_Thom - ARM_JJA_SH
bias_JJA_LH_Thom = WRF_JJA_LH_Thom - ARM_JJA_LH

### Plot ###
x_axis = WRF_JJA_SH.coords['hour']
...
ax1.plot(x_axis, bias_JJA_SH.values, 'r-', label='SH,JJA,WRF_Morri')
ax1.plot(x_axis, bias_JJA_SH_Thom.values, 'r--', label='SH,JJA,WRF_Thom')
ax1.plot(x_axis, bias_JJA_LH.values, 'b-', label='LH,JJA,WRF_Morri')
ax1.plot(x_axis, bias_JJA_LH_Thom.values, 'b--', label='LH,JJA,WRF_Thom')
...
#fig.savefig("../Figure/"+label_str+".JJA.WRF_vs_ARM_SGP"+label_string+".png",dpi=600)
fig.savefig("../Figure/"+label_str+".JJA.WRF_vs_ARM_SGP.Morri_Thom.png",dpi=600)
plt.show()
