...
ax1.set(xlabel='LST(hr), UTC-6', ylabel='WRF precip bias, mm/day', title='Precip, WRF vs ARM SGP')
ax1.grid()
...
fig.savefig("../Figure/Precip.Diurnal.MJJA.WRF_vs_ARM_SGP.png",dpi=600)
plt.show()
