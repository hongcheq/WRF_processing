...
ax1.set(xlabel='LST(hr), UTC-6', ylabel='WRF precip bias, mm/day', title='Precip, WRF vs StageIV')
ax1.grid()
...
fig.savefig("../Figure/Precip.Diurnal.MJJA.StageIV.WRF_vs_ARM_SGP.png",dpi=600)
plt.show()
