...
ax1.plot(x_axis, bias_May.values, label='May')
ax1.plot(x_axis, bias_JJA.values, label='JJA')
...
ax2.plot(x_axis, ARM_May.values, label='May')
ax2.plot(x_axis, ARM_JJA.values, dashes=[6, 2], label='JJA')
