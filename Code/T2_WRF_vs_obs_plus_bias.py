...
levels = np.arange(10.0,40.1,2.0)
contourf_plot1 = ax1.contourf(VAR_WRF_May['lon'],VAR_WRF_May['lat'],VAR_WRF_May,\
        levels=levels,cmap='YlOrRd', transform=data_crs, extend='both')
...
cbar1.set_label('degree C', fontsize=fontsize)
...
cbar2.set_label('degree C', fontsize=fontsize)
...
cbar4.set_label('degree C', fontsize=fontsize)
...
ax5.text(s='NOAA, May', x=0, y=1.02, ha='left', va='bottom', fontsize=fontsize, transform=ax5.transAxes)
...
cbar5.set_label('degree C', fontsize=fontsize)
...
ax6.text(s='NOAA, Jun', x=0, y=1.02, ha='left', va='bottom', fontsize=fontsize, transform=ax6.transAxes)
...
cbar6.set_label('degree C', fontsize=fontsize)
...
ax7.text(s='NOAA, Jul', x=0, y=1.02, ha='left', va='bottom', fontsize=fontsize, transform=ax7.transAxes)
...
cbar7.set_label('degree C', fontsize=fontsize)
...
ax8.text(s='NOAA, Aug', x=0, y=1.02, ha='left', va='bottom', fontsize=fontsize, transform=ax8.transAxes)
...
cbar8.set_label('degree C', fontsize=fontsize)
...
ax9.text(s='WRF-NOAA, May', x=0, y=1.02, ha='left', va='bottom', fontsize=fontsize, transform=ax9.transAxes)
...
contourf_plot9 = ax9.contourf(VAR_bias_May['lon'],VAR_bias_May['lat'],VAR_bias_May,\
        levels=levels,cmap='bwr', transform=data_crs, extend='both')
...
cbar9.set_label('degree C', fontsize=fontsize)
...
ax10.text(s='WRF-NOAA, Jun', x=0, y=1.02, ha='left', va='bottom', fontsize=fontsize, transform=ax10.transAxes)
...
cbar10.set_label('degree C', fontsize=fontsize)
...
ax11.text(s='WRF-NOAA, Jul', x=0, y=1.02, ha='left', va='bottom', fontsize=fontsize, transform=ax11.transAxes)
...
cbar11.set_label('degree C', fontsize=fontsize)
...
ax12.text(s='WRF-NOAA, Aug', x=0, y=1.02, ha='left', va='bottom', fontsize=fontsize, transform=ax12.transAxes)
...
cbar12.set_label('degree C', fontsize=fontsize)
